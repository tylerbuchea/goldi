      ...
      <nav className="navbar has-shadow is-spaced">
        ...
        <div className={`navbar-menu ${showMenu ? 'is-active' : ''}`}>
          <div className="navbar-start">
            ...
            <Link to="/company" className="navbar-item">Browse</Link>
          </div>
